...
Splitter is a separate module of the open source project which is blockchain data service (BDS) and provides data analysis service
...
### Issues
[Github Issues](https://github.com/jdcloud-bds/splitter/issues) could be used to submit bugs and new functions.
